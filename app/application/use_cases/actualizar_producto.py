...
class ActualizarProductoUseCase:
    ...
    - Mantener la trazabilidad (fecha de actualizaci�n)
    ...
    - D (DIP): Depende de abstracci�n (ProductoRepoPort)
    """
    ...
    def ejecutar(
        ...
        """
        Ejecuta la actualizaci�n de un producto.
        ...
        Args:
            ...
            presentacion: Nueva presentaci�n (opcional)
        ...
        Raises:
            ...
            ValueError: Si los precios no son v�lidos
